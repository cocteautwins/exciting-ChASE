...
nullify(np)  
np=>getAttributeNode(thisnode,"mblksiz")
getstructgw%mblksiz=64
if(associated(np)) then
       call extractDataAttribute(thisnode,"mblksiz",getstructgw%mblksiz)
       call removeAttribute(thisnode,"mblksiz")  
endif
